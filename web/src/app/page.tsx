        ...
        <a href="" className="flex items-center gap-3 text-left hover:text-gray-50 transition-colors">
         ...
         <div className="space-y-5">
          <Image src={nlwLogo} alt="NLW Spacetime" />
            ...
            <a className="inline-block rounded-full bg-green-500 px-5 py-3 font-alt text-sm leading-none text-black font-medium uppercase hover:bg-green-600" href="">cadastrar lembraça</a>
